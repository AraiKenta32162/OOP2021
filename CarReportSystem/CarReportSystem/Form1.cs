...
//            // TODO: このコード行はデータを 'infosys202119DataSet.CarReport' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
...
//                //    setCbAuthor(dgvRegistData.Rows[i].Cells[1].ToString());
...
//        private void btDataAdd_Click_1(object sender, EventArgs e)
//        {
//            if (cbAuthor.Text == "" || cbCarName.Text == "")
//            {
//                MessageBox.Show("入力されていません");
